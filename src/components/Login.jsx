      ...
      <div className="row h-100 g-0">
        ...
        >
          <div>
            ...
            <p className="small text-uppercase fw-semibold tracking-wider opacity-75 m-0" style={{ fontSize: '0.75rem', letterSpacing: '1.5px' }}>
              Premium Partner Portal
            </p>
          </div>
          <div className="mb-4" style={{ maxWidth: '480px' }}>
            <p className="fst-italic fw-medium lh-sm m-0" style={{ fontSize: '1.85rem', fontFamily: 'Georgia, serif' }}>
              "From our soil to your doorstep, with integrity and grace."
            </p>
          </div>
        </div>
        ...
        <div className="col-md-6 d-flex flex-column justify-content-center align-items-center bg-white px-4 px-md-5 position-relative">
          ...
          <div className="w-100" style={{ maxWidth: '440px' }}>
            <h2 className="fw-bold mb-2 text-dark" style={{ fontSize: '2.2rem', letterSpacing: '-0.5px' }}>
            ...
            <form onSubmit={onSubmit}>
              <div className="mb-4">
                <label className="form-label text-uppercase fw-bold text-dark" style={{ fontSize: '0.7rem' }}>
                  Email Address
                </label>
                <div className="input-group">
                  <span className="input-group-text bg-white border-end-0 text-secondary opacity-75">
                  ...
                  <input 
                    ...
                    placeholder="name@freshharvest.com" 
                    value={email}
              ...
              <div className="mb-4">
                <div className="d-flex justify-content-between align-items-center mb-1">
                  <label className="form-label text-uppercase fw-bold text-dark m-0" style={{ fontSize: '0.7rem' }}>
                    Password
                  </label>
                </div>
                <div className="input-group">
              ...
              <div className="form-check mb-4 gap-2 d-flex align-items-center">
                <input 
                  type="checkbox" 
                  className="form-check-input m-0 custom-remember-checkbox" 
                  id="rememberDevice" 
